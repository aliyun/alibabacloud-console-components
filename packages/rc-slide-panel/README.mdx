...
[MDXInstruction:importDemo:Nested](./stories/Nested/index.tsx)

从底部滑出的面板：
[MDXInstruction:importDemo:BottomPanelDemo](./stories/BottomPanel/index.tsx)

通过控制 popupProps，可以让 SlidePanel 从内容区域的底部滑出：
[MDXInstruction:importDemo:InLayout](./stories/InLayout/index.tsx)
