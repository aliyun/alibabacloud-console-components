...
export const MenuEventEmitter = new SimpleEventEmitter()

export const dispatchUpdatePath = (path: string) => {
  MenuEventEmitter.emit('updatePath', path)
}
...
const useRoutableMenu = (
  ...
  // 以上三个结果，取出优先级最高的有效值
  const activeKey = [
    anotherSign.current ? activeKeyFromAnother : null,
